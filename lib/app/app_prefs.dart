...
const String PREFS_KEY_IS_TOKEN = "PREFS_KEY_IS_TOKEN";
...
class AppPreferences {
  ...
  Future<void> setToken(String token) async {
    _sharedPreferences.setString(PREFS_KEY_IS_TOKEN, token);
  }

  Future<String> getToken() async {
    return _sharedPreferences.getString(PREFS_KEY_IS_TOKEN) ?? "NO TOKEN SAVED";
  }
